...
class ProgramSessionController extends Controller
{
    public function index(){
        ...
        return view('backend.modules.programs.sessions.show', compact('page'));
    }
    ...
    public function get_ajax_program_session(Request $request){
        ...
        return view('backend.modules.programs.sessions.ajax_sessions', compact('data'));
    }
    ...
    public function edit(Request $request){
        ...
        return view('backend.modules.programs.sessions.edit', compact('data'));
    }
