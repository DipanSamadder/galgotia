...
class PostCategoryController extends Controller
{
    public function index(){
        ...
        return view('backend.modules.websites.posts.categories.show', compact('page'));
    }
    public function get_ajax_posts_cat (Request $request){
        ...
        return view('backend.modules.websites.posts.categories.ajax_posts_cat', compact('data'));
    }
    ...
    public function edit($id){
        ...
        return view('backend.modules.websites.posts.categories.edit', compact('data', 'page'));
    }
