    ...
    <div class="col-lg-5">
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('program_session.store') }}" method="POST" enctype="multipart/form-data" >
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('program_session.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
...
<script>
    ...
    function edit_lg_modal_form(id){
        ...
        $.ajax({
            url: "{{ route('program_session.edit') }}",
            type: "post",
            cache : false,
            data: {
                '_token':'{{ csrf_token() }}',
    ...
    function get_pages(){
        ...
        $.ajax({
            url: "{{ route('ajax_program_session') }}",
            type: "post",
            cache : false,
            data: {
                    '_token':'{{ csrf_token() }}',
