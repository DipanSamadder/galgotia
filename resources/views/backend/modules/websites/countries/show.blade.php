    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('countries.store') }}" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sortname" class="form-control" placeholder="Sort Name" />                                   
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('countries.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
