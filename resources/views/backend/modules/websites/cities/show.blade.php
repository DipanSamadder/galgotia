    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('cities.store') }}" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control w-100  ms select2 mr-2 need_state" name="state_id">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">State <span class="dropdown-loading"></span><small class="text-danger">*</small></label>                                 
                                            <select class="form-control w-100  ms select2 mr-2 get_state" name="state_id">
                                                <option value="">-- Please select --</option>
                                            </select>                             
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('cities.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
