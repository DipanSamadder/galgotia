    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('library.categories.store') }}" method="POST" enctype="multipart/form-data" >
...
@section('footer')
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('library.categories.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('ajax_library_categories') }}">
