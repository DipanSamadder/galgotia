    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('library.books.store') }}" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" class="form-control" placeholder="Code" value="10" />                                   
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="stock" class="form-control" placeholder="Stock" value="10" />                                   
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">                              
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control w-100 mr-2" name="status">
...
@section('footer')
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('library.books.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf 
                <div class="modal-body">
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('ajax_library_books') }}">
