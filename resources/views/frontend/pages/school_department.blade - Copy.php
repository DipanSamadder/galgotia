                ...
                <div class="row m-md-4">
                    <div class="col-md-12">
                        <div class="tabcntnt1 m-md-4 mt-5">
                            ...
                            <div class="mt-4">
                                <div class="row bannercntnt" style="background: url('./assets/images/OLO2DT0.png') 100% 0 no-repeat;">
...
<section class="schoolDep">
    ...
    <div class="tab-content">
        ...
        @if(in_array('Programs', json_decode($needsection_multi_select_0))) 
        <!-- profram tab -->
        <div class="tab-pane " id="Details-78">
            <div class="container">
                <div class="row ">
                    <div class="col-md-12">
                        <div class="aspachiv ">
        ...
        @if(in_array('Faculty', json_decode($needsection_multi_select_0))) 
        <!-- faculty -->
        <div class="tab-pane " id="Details-79">
            <div class="container">
                <div class="row ">
                    <div class="col-md-12">
                        <div class="aspachiv ">
        ...
        @endphp
        @if(!empty($needsection_multi_select_0))
        @if(in_array('Campus Life', json_decode($needsection_multi_select_0))) 
        @if(is_array($vcampuslife) && count($vcampuslife) > 0)

        <!-- campus life -->
        <div class="tab-pane bggray" id="Details-81" >
            <div class="container">
                <div class="row pt80px">
                    <h1 class="f36 gothambold mb-4">Campus life</h1>
                    <div class="col-lg-7 col-md-6 mb-4">
        ...
        @if(is_array($vcampuslife) && count($vcampuslife) > 0)
        <!-- campus life -->
        <div class="tab-pane " id="Details-82">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="f36 gothambold mt45rem mb45rem">Accreditations, Approvals and Ratings</h1>
